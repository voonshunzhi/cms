            ...
            <div class="col-md-8">
                ...
                <?php 
                    if(isset($_GET['post_id'])){
                        ...
                        try{
                        $prepare = $pdo -> prepare("UPDATE posts SET post_view_count = post_view_count + 1 WHERE post_id = :post_id");
                        $prepare -> bindParam(':post_id',$post_id);
                        $prepare -> execute();
                    }catch(Exception $e){
                        echo $e -> getMessage();
                    }
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="<?php echo '/cms/' . $post_image; ?>" alt="">
